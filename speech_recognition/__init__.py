...
class Recognizer(AudioSource):
    ...
    def snowboy_wait_for_hot_word(self, snowboy_location, snowboy_hot_word_files, hot_word_callback, source,
                                  timeout=None):
    ...
    def listen(self, source, timeout=None, phrase_time_limit=None, snowboy_configuration=None):
        ...
        while True:
            ...
            if heard_hotword or snowboy_configuration is None:
                ...
                buffer, delta_time = self.snowboy_wait_for_hot_word(snowboy_location, snowboy_hot_word_files,
                                                                    hot_word_callback, source, timeout)
                heard_hotword = True
    ...
    def recognize_google_cloud(self, audio_data, credentials_json=None, language="en-US", preferred_phrases=None,
        ...
        if credentials_json is not None:
            try:
                ...
                raise AssertionError("``credentials_json`` must be ``None`` or a valid JSON string")
        assert isinstance(language, str), "``language`` must be a string"
